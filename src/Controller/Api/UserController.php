...
/**
     * Fonction permettant de créer un profil user 
     * 
     * @Route ("/api/user/", name="api_user_create", methods={"GET","POST"})
     */
    public function createUser( Request $request, ManagerRegistry $doctrine, EntityManagerInterface $em, SerializerInterface $serializer, ValidatorInterface $validator, UserPasswordHasherInterface $userPasswordHasher)
    {
        ...
        } catch (NotEncodableValueException $em) {
